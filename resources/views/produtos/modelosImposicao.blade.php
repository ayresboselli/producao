...
@section('title', 'Modelos de Imposição')

@section('content')
<h1 class="mt-4">Modelos de Imposição</h1>
<ol class="breadcrumb mb-4">
	<li class="breadcrumb-item active">Modelos de Imposição</li>
</ol>

<div class="card mb-4">
	<div class="card-header">
		<a href="/modelo_imposicao" class="btn btn-primary btn-sm">Adicionar</a>
	</div>
	<div class="card-body">
		@if (session('status'))
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h4 class="modal-title">Modelo de Imposição</h4>
				<button type="button" class="close" data-dismiss="modal">&times;</button>
			</div>

			<!-- Modal body -->
			<div class="modal-body">
				<h4>Tem certeza que deseja deletar o modelo <span id='titulo_deletar'></span>?</h4>
			</div>

			<!-- Modal footer -->
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
				<form action="/modelo_imposicao/deletar" method='post'>
					@csrf
