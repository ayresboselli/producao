					...
					<tr>
						...
						<td style="max-width:60px">
							...
							<div class='row'>
								...
								<div class='col-sm-6'>
									@if($substrato->produtos == 0)<a href="javascript:void(0)" title='Excluir' onclick="Deletar({{ $substrato->id }},'{{ $substrato->titulo }}')" class='text-danger'><i class='fa fa-trash'></i></a>@endif
								</div>
							</div>
							@endif
						</td>
